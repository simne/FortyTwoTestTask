...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MHttpRequest.meta_PATH_INFO'
        db.add_column(u'hello_mhttprequest', 'meta_PATH_INFO',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MHttpRequest.meta_PATH_INFO'
        db.delete_column(u'hello_mhttprequest', 'meta_PATH_INFO')
    ...
    models = {
        ...
        u'hello.mhttprequest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meta_CONTENT_LENGTH': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
