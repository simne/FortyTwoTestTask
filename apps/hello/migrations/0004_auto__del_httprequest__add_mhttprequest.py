...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MHttpRequest'
        db.create_table(u'hello_mhttprequest', (
            ...
            ('rqdate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'hello', ['MHttpRequest'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'MHttpRequest'
        db.delete_table(u'hello_mhttprequest')
