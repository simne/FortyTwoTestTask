...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MHttpRequest.rqdump'
        db.add_column(u'hello_mhttprequest', 'rqdump',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MHttpRequest.rqdump'
        db.delete_column(u'hello_mhttprequest', 'rqdump')
